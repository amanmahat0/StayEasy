...
export default function Confirmations({ onBack }: { onBack: () => void }) {
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6">
      ...
      <h1 className="text-2xl sm:text-3xl font-black text-gray-900 text-center mb-2">Digital Rental Agreement</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
        <div className="lg:col-span-8 bg-white rounded-[32px] border border-gray-100 shadow-sm overflow-hidden flex flex-col h-auto lg:h-[600px]">
          <div className="p-4 sm:p-6 bg-gray-50 border-b flex items-center gap-4">
          ...
          <div className="p-4 sm:p-6 lg:p-10 overflow-y-auto text-sm leading-relaxed text-gray-600 space-y-6">
             <p className="font-bold text-gray-900 uppercase tracking-widest text-xs">Property Details</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 bg-gray-50 p-4 sm:p-6 rounded-2xl">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-[32px] border border-gray-100 shadow-sm">
          ...
          <div className="bg-emerald-50 p-4 sm:p-6 rounded-[32px] border border-emerald-100 flex gap-4 items-start">
